...
// TODO: Add a Javascript setInterval() method that will call the Run() function above every 200 milliseconds. Note: in the video, 
...
function checkPageBounds(direction, imgWidth, pos, pageWidth) {
  ...
  // TODO: Complete this to reverse direction upon hitting screen edge
    ...
    if (direction === 0 && pos > pageWidth - imgWidth){
        ...
        //console.log('left edge reached/passed');
        direction = 0;
    }
  return direction;
}
